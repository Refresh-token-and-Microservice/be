...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final UserDetailsService userDetailsService; // Đảm bảo bạn đã có Bean này (thường là UserService implements UserDetailsService)
    ...
    protected void doFilterInternal(
        ...
        // Nếu không có token trong cookie, cho qua (để đến Controller xử lý lỗi 403 sau)
        if (token == null) {
