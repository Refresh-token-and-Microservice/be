package com.example.auth_service.auth.infrastructure.adapter.in.web;
...
import com.example.auth_service.auth.application.port.out.JwtPort;
import com.example.auth_service.auth.application.service.TokenApplicationService;
...
public class AuthController {
    ...
    @Autowired
    private AuthUseCase userService;

    @Autowired
    private JwtPort jwtService;

    @Autowired
    private TokenApplicationService refreshTokenService;
